...
class CarController:
  ...
  def update(self, CC, CS):
    ...
    if self.CP.carFingerprint in CANFD_CAR:
      ...
      if self.frame % 2 == 0 and True: # and self.mdpsMode:
        enabled_speed = 60
        clu11_speed = CS.clu11["CF_Clu_Vanz"]
        if clu11_speed > enabled_speed:
          enabled_speed = clu11_speed
        can_sends.append(hyundaican.create_clu11_mdps(self.packer, self.frame, CS.clu11, Buttons.NONE, self.CP.carFingerprint, 1, enabled_speed))
      ...
      if self.CP.carFingerprint in (CAR.GENESIS_G90_2019, CAR.GENESIS_G90, CAR.K7) or True: #self.mdpsMode
